...
\begin{definition}[Parking Function]
    ...
    In other words, $\#\{i\ |\ a_i \leqslant k\} \geqslant k\ \forall k$.
\end{definition}
...
\begin{theorem}[Konheim and Weiss, 1966]
...
As comparing two parking functions can be tricky, one could
wonder whether there exists an other combinatorial structure
with a well-defined order that is in bijection with
$\mathcal{PF}_n$ or $\mathcal{PF'}_n$. 
The next section will present such a candidate.  