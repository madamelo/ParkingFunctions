...
\begin{definition}[a, b - Non-crossing Partition]
    ...
    a pair $(P,f)$ such that :\\
    \begin{itemize}
        \item $P = (B_1, \ldots, B_k) \in 
            \mathcal{NC}_{b-1}$
        \item $f : \{B_i\} \to \mathbb{N}$
        \item $\displaystyle \sum_{1 \leqslant i 
        \leqslant k}{f(B_i)} = a$
        \item $\displaystyle \forall\ 1 \leqslant i 
        \leqslant k,\ \sum_{1 \leqslant j \leqslant i}
        {f(B_i)} \geqslant \frac{a}{b}min(B_i)$
    \end{itemize}
    We denote TODO
\end{definition}
