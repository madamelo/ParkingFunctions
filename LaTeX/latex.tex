...
\begin{example}[Shape of the poset of $\mathcal{PF}_3$]
    \text {}\\
    \begin{align*}
    \includegraphics[scale = 0.8, angle = 180]{fig0}
    \end{align*}
    \begin{center}
...
\begin{example}[Shape of the poset of $\mathcal{NC}_4$]
    \text {}\\
    \begin{align*}
    \includegraphics[scale = 0.7, angle = 180]{fig2}
    \end{align*}
    \begin{center}
        This figure was generated with Sagemath.
...
\begin{example}[Shape of the poset of $\mathcal{NC}^2_3$]
    \text {}\\
    \begin{align*}
    \includegraphics[scale = 0.8, angle = 180]{fig3}
    \end{align*}
    \begin{center}
        This figure was generated with Sagemath.
        There are $4^2 = 16$ elements in this poset.
...
\begin{rem}
    This poset is in \emph{bijection} with the poset of
    $\mathcal{PF}_n$, and each can be obtained by applying
    the aforementioned bijection between $\mathcal{NC}_n$
    and $\mathcal{PF}_n$ to the elements of the other :
