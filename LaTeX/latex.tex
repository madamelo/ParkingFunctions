...
\begin{rem}    
    $\mathcal{PF}^{n+1}_n = \mathcal{PF}_n$.
...
\begin{example}[$a = 4, b = 3$]
    ...
    3 \frac{1}{4}]$
    \begin{align*}
        &f_1 = (1, 1, 2, 2) \in \mathcal{PF'}^3_4\\
        &f_2 = (1, 1, 2, 1) \notin \mathcal{PF'}^3_4,
        \text{ even though } f_2 \in \mathcal{PF}^3_4.
    \end{align*}
\end{example}

\begin{theorem}
    Let $pf'^b_a$ be the cardinal of
    $\mathcal{PF'}^b_a$.
    We have $$\displaystyle pf'^b_a = 
