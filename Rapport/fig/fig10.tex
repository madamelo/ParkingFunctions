\begin{center}
    \begin{tikzpicture}[scale=0.9]
        ...
        \node [color = cyan] at (-1, 4.5) {\textbf{6}};
        ...
        \node [color = violet] at (-2, 4.5) {\textbf{6}};
        ...
        \fill[color = cyan] (-1,-1.9) rectangle
            (-1.5,-1.7);
        \node at (0.5,-1.8) {$104503600200$};
        \fill[color = violet] (3,-1.9) rectangle
            (2.5,-1.7);
        \node at (4.5,-1.8) {$10345060200$};
        \fill[color = red] (7,-1.9) rectangle
            (6.5,-1.7);
        \node at (8.2,-1.8) {différence};
    \end{tikzpicture}
\end{center}