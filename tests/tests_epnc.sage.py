...
# This file was *autogenerated* from the file ../tests/tests_epnc.sage
...
sage.repl.load.load(sage.repl.load.base64.b64decode("Li4vY29kZS9lcG5jLnNhZ2U="),globals(),False)
