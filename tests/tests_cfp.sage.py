...
# This file was *autogenerated* from the file ../tests/tests_cfp.sage
...
sage.repl.load.load(sage.repl.load.base64.b64decode("Li4vY29kZS9jZnAuc2FnZQ=="),globals(),False)
