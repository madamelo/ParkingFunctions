...
# This file was *autogenerated* from the file ../tests/tests_pnc.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_5 = Integer(5); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_10 = Integer(10)
sage.repl.load.load(sage.repl.load.base64.b64decode("Li4vY29kZS9wbmMuc2FnZQ=="),globals(),False)
