...
g4 = generate_pnc_k_h (_sage_const_4 , _sage_const_2 , _sage_const_2 )
k = _sage_const_0 
for e in g4 :
    print (e)
    k = k + _sage_const_1 
print (k)
print (cpt_pnc_k_h (_sage_const_4 , _sage_const_2 , _sage_const_2 ))
