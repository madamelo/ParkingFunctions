...
def zeta_edeltwo (n, m) :
    g = list (generate_edeltwo (m))

    # Zeta does not work because of lists
    # Thus this is a terrible replacement function
    ...
    LC = [i for i in range (m)]
    PC = product (LC, repeat = n - 1)
    choices = []
