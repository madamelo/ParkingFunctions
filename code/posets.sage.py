...
_sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_10 = Integer(10); _sage_const_7 = Integer(7); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_15 = Integer(15); _sage_const_2 = Integer(2); _sage_const_8 = Integer(8); _sage_const_5 = Integer(5)
...
L14 = list (generate_abfpp (_sage_const_4 , _sage_const_3 ))
...
L14_ = []
for f in L14 :
    Df, lf = rfp_to_drdyck (f.p, _sage_const_4 , _sage_const_3 )
    R = DRDYCK (Df, lf)
    L14_.append (R)
...
print ("My a, b - FP cover with a < b")
L15 = list (generate_abfpp (_sage_const_3 , _sage_const_5 ))
...
L15_ = []
for f in L15 :
    Df, lf = rfp_to_drdyck (f.p, _sage_const_3 , _sage_const_5 )
    R = DRDYCK (Df, lf)
    L15_.append (R)
